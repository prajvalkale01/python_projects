...
# Set up the right frame for dynamic content
        ...
        self.c2w_right_frame = tk.Frame(self.c2w_background_frame,
        bg="#BCD2E8", width=1200, height=1000)
...
# Create and pack widgets for Font Library
            ...
            self.input_label = ttk.Entry(self.c2w_right_frame, width=60,
...
# Create buttons for different fonts
            self.c2w_button_label1 = ttk.Button(self.c2w_right_frame,
            text="Poppins", style="Rounded.TButton", command=self.c2w_poppinClicked)

            self.c2w_button_label1.pack()
            self.c2w_button_label1.place(x=60*2, y=350, anchor='nw')
            self.c2w_button_label2 = ttk.Button(self.c2w_right_frame,
            text="Modern", style="Rounded.TButton", command=self.c2w_modernClicked)

            self.c2w_button_label2.pack()
            self.c2w_button_label2.place(x=60*5, y=350, anchor='nw')
            self.c2w_button_label3 = ttk.Button(self.c2w_right_frame,
            text="Courier", style="Rounded.TButton", command=self.c2w_courierClicked)
            ...
            self.c2w_button_label5 = ttk.Button(self.c2w_right_frame,
            text="Calibri", style="Rounded.TButton", command=self.c2w_calibriClicked)
...
# Change the font and display entered text
        self.c2w_show_label.config(text=self.input_label.get(),
